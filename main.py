...
class App:
    def __init__(self):
        ...
        self.command_params = [ParamsCommand('--timelock', 'Время до блокировки', Entry),
                               ParamsCommand('--blockbtn', 'Отображение кнопки блокирования экрана', Checkbutton),
                               ParamsCommand('--autohide', 'Автоматического скрытия главной панели', Checkbutton),
                               ParamsCommand('--quiet', 'Подавление вывода на экран', Checkbutton)]
    ...
    def start(self):
        self.make_window('Киоск', self.create_kiosk())
